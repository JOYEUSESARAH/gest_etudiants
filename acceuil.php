            ...
            <div class="global-content">
                <div class="contenu">
                    <aside class="d-flex flex-column p-3">
                        <h3 id="navig">MENU</h3>
                        <h3 class="btn btn-dark p-3 m-1"> <a class="text-light h-100 w-100" href="../../acceuil.php"> ACCEUIL <i class="fa fa-home"></i></a> </h3>
                        <h3 class="btn btn-dark p-3 m-1"> <a class="text-light h-100 w-100" href="view/etudiant/list.php"> ETUDIANT </a> </h3>
                        <h3 class="btn btn-dark p-3 m-1"> <a class="text-light h-100 w-100" href="view/filière/list.php"> FILIERE </a></h3>
                        <h3 class="btn btn-dark p-3 m-1"> <a class="text-light h-100 w-100" href="view/niveau/list.php"> NIVEAU </a></h3>
